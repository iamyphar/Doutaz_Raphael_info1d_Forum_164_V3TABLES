"""
    File : msg_erreurs.py
    Author : Raphaël Doutaz 2021.03.16
...
msg_erreurs = {
    ...
    "ErreurDoublonValue": {
        "message": "Cette value existe déjà.",
        "status": 400
    },
    "ErreurDictionary": {
        "message": "(Raphaël Doutaz du 164) Une value du dictionary n'existe pas !!!",
        "status": 400
    },
    ...
    "ErreurDeleteContrainte": {
        "message": "Impossible d'effacer, car cette value est référencée ailleurs",
        "status": 400
    },
...
"""
    Les constantes originales sont définies (dans PyMysql) dans le file "ER.py"
    Répertoire : /venv/Lib/site-packages/pymysql/constants)
    Il suffit de chercher cd file avec PyCharm "CTRL-SHIFT-N" "all places" "ER.py"
