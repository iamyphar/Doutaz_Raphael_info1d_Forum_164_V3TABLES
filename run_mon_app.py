...
from APP_Forums_164 import ADRESSE_SRV_FLASK
from APP_Forums_164 import DEBUG_FLASK
from APP_Forums_164 import PORT_FLASK
from APP_Forums_164 import SECRET_KEY_FLASK
...
if __name__ == '__main__':
    # Raphaël Doutaz 2022.04.11
    # Les variables d'environnement de FLASK sont définies dans le file ".env"
